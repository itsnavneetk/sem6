...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            database.insertProd("00123","Washing Powder Nirma", 54);
            ...
            database.insertProd("19866","Tupperware 1ltr Bottle", 119);
            database.insertProd("01230","Nike Shoes", 2399);
            database.insertProd("98102","Rorito Flymax Gel", 10);
        }
