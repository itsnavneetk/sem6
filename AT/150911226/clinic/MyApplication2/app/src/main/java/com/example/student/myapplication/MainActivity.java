...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            database=openOrCreateDatabase("cli",MODE_PRIVATE,null);
            database.execSQL("CREATE TABLE IF NOT EXISTS student(roll VARCHAR(20) PRIMARY KEY, pid VARCHAR(20), name VARCHAR(20), marks VARCHAR(10));");
        }
        catch (Exception e){
        ...
        insertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {   String pid = pID.getText().toString();
                    ...
                    try {
                        database.execSQL("INSERT INTO student VALUES('"+roll+"', '"+pid+"', '"+name+"', '"+marks+"')");
                        Toast.makeText(getApplicationContext(),"Inserted!", Toast.LENGTH_SHORT).show();
                    }
                    catch (Exception e){

                        if (e.toString().contains("code 1555"))
                            Toast.makeText(getApplicationContext(),"Doctor not available"+roll+" already exists",Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roll.equals(""))
                {
                    Toast.makeText(getApplicationContext(),"Please enter DOC ID",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    String name=nameEdit.getText().toString();
